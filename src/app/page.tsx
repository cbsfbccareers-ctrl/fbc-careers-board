...
const JOB_COLUMNS =
  "id, status, created_at, title, company, locations, compensation, vertical_tag, employment_type, position, application_url, application_email, application_instructions, application_deadline, expires_at, original_posted_date, visa_sponsorship, description";
